...
<h3>Price: ${product.price * quantity}</h3>
      ...
      <div>
       ...
       <form action="" style={{background:"gray", width:"350px", justifyContent:"center", marginLeft:"5%"}}>
        <input type="text" name="" id="" placeholder='name'style={{marginTop:"3%", height:"40px"}}/>
        <input type="number" name="" id="" placeholder='phone'/>
        <input type="text" name="" id="" placeholder='type your full address'/>
