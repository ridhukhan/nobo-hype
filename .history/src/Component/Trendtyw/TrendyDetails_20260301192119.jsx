...
<h3>Price: ${product.price * quantity}</h3>
      ...
      <div>
       ...
       <form action="" style={{background:"gray", width:"400px", justifyContent:"center", marginLeft:"4%"}}>
        ...
        <input type="email" name="" id="" placeholder='your emai' style={{marginTop:"3%", height:"30px", width:"360px", borderRadius:"10px", border:"2px red solid", color:"black", fontSize:"24px"}}/>
